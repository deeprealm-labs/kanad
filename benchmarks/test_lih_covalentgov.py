"""Test LiH with CovalentGov ansatz"""
import time
import numpy as np
...
# VQE
ansatz = CovalentGovernanceAnsatz(n_qubits=12, n_electrons=4, n_layers=2)
...
print(f"LiH/CovalentGov/SLSQP: E={E_vqe:.6f} Ha, error={err:+.3f} mHa, time={dt:.1f}s")
