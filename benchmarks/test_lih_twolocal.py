...
# VQE
ansatz = TwoLocalAnsatz(n_qubits=12, n_electrons=4, n_layers=2)
...
print(f"LiH/TwoLocal/SLSQP: E={E_vqe:.6f} Ha, error={err:+.3f} mHa, time={dt:.1f}s")
