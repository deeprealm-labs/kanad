...
# VQE
ansatz = IonicGovernanceAnsatz(n_qubits=4, n_electrons=2, n_layers=2)
...
print(f"H2/IonicGov/SLSQP: E={E_vqe:.6f} Ha, error={err:+.3f} mHa, time={dt:.1f}s")
