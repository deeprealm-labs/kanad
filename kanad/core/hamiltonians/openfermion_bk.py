"""
Bravyi-Kitaev transformation using OpenFermion (validated reference).

OpenFermion provides a well-tested implementation of the Bravyi-Kitaev
...
def openfermion_bravyi_kitaev(
    ...
    """
    Build Hamiltonian using OpenFermion's Bravyi-Kitaev transformation.
    ...
    logger.info(f"Using OpenFermion Bravyi-Kitaev: {n_orbitals} orbitals → {n_qubits} qubits")
    ...
    logger.info(f"Built Hamiltonian with {len(pauli_op)} Pauli terms (BK transformation)")
